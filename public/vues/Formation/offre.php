<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form style="margin-bottom: 40px" action="<?php echo (explode("index.php", $_SERVER['PHP_SELF']))[0] ?>formation/update/<?php echo($arg['formation']->getId()) ?>"
                ...
                <div class="form-group">
                    ...
                    <textarea cols="5" type="text" class="form-control" id="cont-forma" placeholder="Entrez le contenu de la formation"
